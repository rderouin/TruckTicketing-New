...
public class EDIFieldLookupRepository : CosmosEFCoreSearchRepositoryBase<EDIFieldLookupEntity>
{
    public EDIFieldLookupRepository(ISearchResultsBuilder resultsBuilder,
    ...
    public IQueryable<T> ApplyKeywordSearchImpl<T>(IQueryable<T> source, string keywords)
    {
        ...
        if (source is not IQueryable<EDIFieldLookupEntity> typedSource)
        {
            return source;
        }
