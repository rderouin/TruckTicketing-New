...
public class LoadConfirmationSetRedFlagBasedOnAccountTask : WorkflowTaskBase<BusinessContext<LoadConfirmationEntity>>
{
    private readonly IProvider<Guid, AccountEntity> _accountProvider;

    public LoadConfirmationSetRedFlagBasedOnAccountTask(IProvider<Guid, AccountEntity> accountProvider)
    {
