...
public class InvoiceModel
{
    ...
    public InvoiceEmailModel EmailDelivery { get; set; }
    ...
    public List<InvoiceLineModel> LineItems { get; set; }
}
...
public class InvoiceLineModel
{
    ...
    [JsonProperty("Tax")]
    public List<InvoiceTaxModel> Tax { get; set; }
    ...
    [JsonProperty("Edi")]
    public InvoiceLineEdiModel Edi { get; set; }
}
...
public class InvoiceLineEdiModel
{
