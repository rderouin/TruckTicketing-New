...
public class MaterialApproval : GuidApiModelBase, IFacilityRelatedModel
{
    ...
    public List<ApplicantSignatory> ApplicantSignatories { get; set; } = new();

    public List<LoadSummaryReportRecipient> LoadSummaryReportRecipients { get; set; } = new();
...
public class LoadSummaryReportRecipient : GuidApiModelBase
{
...
public class ApplicantSignatory : GuidApiModelBase
{
    public Guid AccountContactId { get; set; }
