...
[EntityProcessorFor(ServiceBusConstants.EntityMessageTypes.InvoiceAck)]
public class InvoiceAckProcessor : BaseEntityProcessor<InvoiceAckMessage>
{
    private readonly IProvider<Guid, InvoiceEntity> _invoiceProvider;

    private readonly ILogger<InvoiceAckProcessor> _logger;

    private readonly IManager<Guid, NoteEntity> _noteManager;

    public InvoiceAckProcessor(IProvider<Guid, InvoiceEntity> invoiceProvider, ILogger<InvoiceAckProcessor> logger, IManager<Guid, NoteEntity> noteManager)
    {
    ...
    public override async Task Process(EntityEnvelopeModel<InvoiceAckMessage> entityModel)
    {
...
public class InvoiceAckMessage
{
