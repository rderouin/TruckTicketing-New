...
{
    public override Assembly[] TargetAssemblies =>
        new[] { GetType().Assembly, typeof(Domain.PackageModule).Assembly, typeof(Shared.Domain.PackageModule).Assembly, typeof(TruckTicketing.Domain.PackageModule).Assembly };
    ...
    public override void Configure(IIoCProvider builder)
    {
        ...
        FunctionAppSettingsBase.CoalesceEnvironmentVariables = true;
