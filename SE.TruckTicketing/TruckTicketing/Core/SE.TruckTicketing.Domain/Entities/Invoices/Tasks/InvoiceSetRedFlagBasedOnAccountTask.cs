...
public class InvoiceSetRedFlagBasedOnAccountTask : WorkflowTaskBase<BusinessContext<InvoiceEntity>>
{
    private readonly IProvider<Guid, AccountEntity> _accountProvider;

    public InvoiceSetRedFlagBasedOnAccountTask(IProvider<Guid, AccountEntity> accountProvider)
    {
