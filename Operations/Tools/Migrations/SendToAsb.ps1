...
$ConnectionString="Endpoint=sb://zcac-sb-dev2-public-kii7r32bhvqoo.servicebus.windows.net/;SharedAccessKeyName=DeveloperSharedKey;SharedAccessKey=2T08IA5lbY6qlO6E2YXhkJTZ77YNa7yclcARLtQ1HF0=;EntityPath=d365fo-business-events"
$AlertName="Test"
