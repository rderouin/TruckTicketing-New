...
namespace Trident.EFCore
{
    ...
    public class EFCoreDataContext : DbContext, IEFDbContext
    {
        ...
        private readonly IChangeObserver _changeObserver;
        ...
        public override async Task<int> SaveChangesAsync(CancellationToken cancellationToken = default)
        {
            ...
            if (ChangeTracker.HasChanges())
            {
                ...
                var changes = await _changeObserver.GetChanges(this);
                var result = await base.SaveChangesAsync(cancellationToken);
                await _changeObserver.Publish(changes);
        ...
        protected object Clone()
        {
            return (IContext)Activator.CreateInstance(this.GetType(), new object[] {
               ...
               IoCServiceLocator,
               IoCServiceLocator.Get<IChangeObserver>()
            });
        }
