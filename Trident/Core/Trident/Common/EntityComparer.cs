...
namespace Trident.Common
{
    ...
    public class EntityCompareConfig
    {
        ...
        /// <summary>
        ///     A list of types to be ignored in the comparison. The default is to compare all types.  A typical thing to not
        ///     compare are GUIDs
        /// </summary>
        public List<Type> TypesToIgnore { get; } = new List<Type>();
    ...
    public class EntityComparer : IEntityComparer
    {
        ...
        public IEnumerable<EntityCompareResult> Compare<TEntity>(TEntity original,
                                                                 TEntity target,
                                                                 EntityCompareConfig config) where TEntity : class
        {
            ...
            comparer.Config.TypesToIgnore = config.TypesToIgnore;
