...
namespace Trident.Validation
{
    ...
    public class ValidationRollupException : Exception
    {
        ...
        public ValidationRollupException(string message, Exception ex)
            : base(string.IsNullOrWhiteSpace(message) ? DefaultErrorMessage : message, ex)
        {
        }
        ...
        public ValidationRollupException(IEnumerable<ValidationResult> validationErrors) :
            this(validationErrors?.ToJson())
        {
        ...
        where TErrorCode : struct
    {
        ...
        public ValidationRollupException(string message, TErrorCode code)
        {
        ...
        where TEntity : Entity
    {
        ...
        /// <param name="memberName">Name of the member.</param>
        /// <param name="code">The code.</param>
        public ValidationRollupException(string memberName, TErrorCode code)
        {
