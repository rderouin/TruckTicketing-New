...
public class DropDownFilterOptions : ListFilterOptions
{
...
public class SingleSelectDropDownFilterOptions : ListFilterOptions
{
...
public class NumericFilterOptions : FilterOptions
{
    public long? LowerBoundDefaultValue { get; set; }

    public long? UpperBoundDefaultValue { get; set; }
...
public class DoubleFilterOptions : FilterOptions
{
    public double? LowerBoundDefaultValue { get; set; }

    public double? UpperBoundDefaultValue { get; set; }
