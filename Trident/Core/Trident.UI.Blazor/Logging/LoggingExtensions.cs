...
namespace Trident.UI.Blazor.Logging
{
    public static class LoggingExtensions
    {
        ...
        /// </summary>
        public static ILoggingBuilder AddBlazorClientLogging(this ILoggingBuilder builder, ILoggingConfiguration logConfig, IAppInsightsConfig appInsightsConfig = null, bool init = true)
        {
            AppInsights.ApplicationInsights.InitApplicationInsights = init;
